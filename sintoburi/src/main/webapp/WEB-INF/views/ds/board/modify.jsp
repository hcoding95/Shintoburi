...
<div class="row" style="margin-left:300px;margin-right:auto;">
		<div class="col-md-10">
			<span style="font-size:25px;">글제목</span>      
				<input type="text" class="form-control" id="title" name="title" value = "${modifyDetail.title}"required/>
			...
			<form role="form">
				...
				<!-- 글내용 입력 -->
				<textarea class="summernote" name="content" id="content" required>${modifyDetail.content}</textarea>
